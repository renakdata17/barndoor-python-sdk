...
from barndoor.sdk.exceptions import HTTPError, TokenValidationError
...
class TestBarndoorSDK:
    ...
    async def test_token_validation_prod_success(self, sdk_client):
        ...
        with patch.dict('os.environ', {'BARNDOOR_ENV': 'prod'}):
            with patch.object(sdk_client, 'validate_cached_token', new_callable=AsyncMock) as mock_validate:
